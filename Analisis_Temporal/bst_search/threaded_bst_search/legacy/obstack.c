...
#if (_GNU_OBSTACK_INTERFACE_VERSION == _OBSTACK_INTERFACE_VERSION || (_GNU_OBSTACK_INTERFACE_VERSION == 1 && _OBSTACK_INTERFACE_VERSION == 2 && defined SIZEOF_INT && defined SIZEOF_SIZE_T && SIZEOF_INT == SIZEOF_SIZE_T))
...
#if ((defined __GNUC__ && (__GNUC__ >= 3 || (__GNUC__ == 2 && __GNUC_MINOR__ >= 8))) || (defined __SUNPRO_C && __SUNPRO_C >= 0x5110))
