 ...
 *  Compilación: gcc expBusqueda_time.c ../tiempo.c -o exponencial
 *  Ejecución: ./exponencial n < ../../../10millones.txt
*/
...
int main (int argc, char* argv[]){
    ...
    if(argc!=2){ //Si no se introducen exactamente 2 argumentos (Cadena de ejecución y tamañoArreglo=n)
